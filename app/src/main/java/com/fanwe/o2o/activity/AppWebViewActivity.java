...
public class AppWebViewActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new SDProgressDialog(AppWebViewActivity.this);
        ...
        String Url = mUrl + "&sess_id=" + url_token;
    ...
    private void initWebSetting(String url) {
        ...
        mWebView.setLayerType(View.LAYER_TYPE_SOFTWARE, null);//处理屏幕闪白
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                try {
                    if (url.startsWith("mqqapi://")) {   //QQ第三方支付
                        ...
                        return true;
                    } else if (url.contains("alipays://")) {   //支付宝第三方支付
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(url));
                        startActivity(intent);
                        return true;
