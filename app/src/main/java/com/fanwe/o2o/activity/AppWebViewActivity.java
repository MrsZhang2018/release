...
//                openSDKPAY(uc_Save_InchargeActModel);
                Toast.makeText(getBaseContext(), "暂未开放", Toast.LENGTH_SHORT).show();
                break;
