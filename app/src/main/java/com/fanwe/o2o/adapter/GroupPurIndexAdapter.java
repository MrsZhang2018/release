...
public class GroupPurIndexAdapter extends SDSimpleAdapter<GroupPurIndexIndexsListModel>
{
	...
	public GroupPurIndexAdapter(List<GroupPurIndexIndexsListModel> listModel, Activity activity)
	{
	...
	@Override
	public void bindData(final int position, View convertView, ViewGroup parent, final GroupPurIndexIndexsListModel model)
	{
...
//				Intent intent = AppRuntimeWorker.createIntentByType(type, "",Integer.parseInt(model.getId()));
