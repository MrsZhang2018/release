 ...
 */
public class O2oTabHotBannerPagerAdapter extends SDPagerAdapter<WapIndexAdvsModel>
{

    public O2oTabHotBannerPagerAdapter(List<WapIndexAdvsModel> listModel, Activity activity)
    {
    ...
    public View getView(final ViewGroup container, final int position)
    {
        ...
        final WapIndexAdvsModel model = getItemModel(position);
