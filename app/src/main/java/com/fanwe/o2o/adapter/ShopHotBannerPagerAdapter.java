 ...
 */
public class ShopHotBannerPagerAdapter extends SDPagerAdapter<ShopIndexAdvsModel>
{

    public ShopHotBannerPagerAdapter(List<ShopIndexAdvsModel> listModel, Activity activity)
    {
    ...
    public View getView(final ViewGroup container, final int position)
    {
        ...
        final ShopIndexAdvsModel model = getItemModel(position);
