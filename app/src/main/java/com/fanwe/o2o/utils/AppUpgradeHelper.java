...
//            ReporterUtil.reportUserError("create apk dir fail，can not upgrade app");
        ...
        if (initActModel != null)
        {
            ...
            {
                // 有新版本
                apkUrl = initActModel.getAndroid_filename();
                ...
                isForceUpgrade = "1".equals(initActModel.getAndroid_forced_upgrade()) ? true : false;
                ...
                } else
                {
                    ...
                    {
                        showUpgradeDialog(initActModel);
                    }
                }
            } else
            {
     ...
     * @param model
     */
    protected void showUpgradeDialog(final Init_indexActModel model)
    {
        Activity activity = SDActivityManager.getInstance().getLastActivity();
        if (activity == null)
        {
