...
public class CommonRatingBar extends LinearLayout {
  ...
  public CommonRatingBar(Context context, AttributeSet attrs) {
    ...
    TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.CommonRatingBar);
    starImageSize = mTypedArray.getDimension(R.styleable.CommonRatingBar_starImageSize, 20);
    starPadding = mTypedArray.getDimension(R.styleable.CommonRatingBar_starPadding, 10);
    starStep = mTypedArray.getFloat(R.styleable.CommonRatingBar_starStep, 1.0f);
    stepSize = StepSize.fromStep(mTypedArray.getInt(R.styleable.CommonRatingBar_stepSize, 1));
    starCount = mTypedArray.getInteger(R.styleable.CommonRatingBar_starCount, 5);
    starEmptyDrawable = mTypedArray.getDrawable(R.styleable.CommonRatingBar_starEmpty);
    starFillDrawable = mTypedArray.getDrawable(R.styleable.CommonRatingBar_starFill);
    starHalfDrawable = mTypedArray.getDrawable(R.styleable.CommonRatingBar_starHalf);
    mClickable = mTypedArray.getBoolean(R.styleable.CommonRatingBar_clickable, true);
    mTypedArray.recycle();
