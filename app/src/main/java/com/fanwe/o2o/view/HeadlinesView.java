...
public class HeadlinesView extends LinearLayout
{
    ...
    //显示文字的尺寸
//    private final float TEXTSIZE = 13f;
    private HeadlinesAdapter mAdapter;
    private final float advHeight = 45;
    //显示的view
...
//        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        ...
        mAdverHeight = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, advHeight, getResources().getDisplayMetrics());
        int gap = array.getInteger(R.styleable.HeadlinesView_gap, mGap);
        int animDuration = array.getInteger(R.styleable.HeadlinesView_animDuration, mAnimDuration);
     ...
     * 设置数据
     */
    public void setAdapter(HeadlinesAdapter adapter)
    {
