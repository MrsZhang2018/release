...
public class PaySdkModel extends BaseActModel
{
	...
	public IAppPayModel getIAppPayModel()
	{
		String s_config = JSON.toJSONString(config);
		return JSON.parseObject(s_config, IAppPayModel.class);
	}

	public JuBaoSdkModel getJuBaoSdkModel()
	{
		String s_config = JSON.toJSONString(config);
		return JSON.parseObject(s_config, JuBaoSdkModel.class);
	}
