...
public class AppUpgradeService extends Service
{
	...
	private void showDialogUpgrade(final InitUpgradeModel model)
	{
		...
		if (isForceUpgrade)
		{
			Dialog dialog = CustomDialog.alert(SDActivityManager.getInstance().getLastActivity(), "更新内容:" + model.getAndroid_upgrade(), "确定", new OnConfirmListener()
			{
				@Override
		...
		{
			CustomDialog.confirm(SDActivityManager.getInstance().getLastActivity(), "更新内容:" + model.getAndroid_upgrade(), "确定", "取消", new OnConfirmListener()
			{
