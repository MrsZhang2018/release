...
public class SDGridLinearLayout extends LinearLayout
{
    ...
    private void initParams()
    {
        ...
        if (totalWidth == 0 && getLayoutParams() != null && colNumber == 1)
        {
            totalWidth = getLayoutParams().width;
        }

        avalibleWidth = totalWidth;
        ...
        if (totalWidth > 0 && adapter != null && strokeCreater != null && colNumber > 1)
        {
            ...
            avalibleWidth -= totalVerticalStrokeWidth;
        }
    }
