		...
		SDActivityDispatchKeyEventListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		if (activity != null)
		{
			activity.getListenerManagerDispatchTouchEvent().add(this);
			activity.getListenerManagerDispatchKeyEvent().add(this);
		}
	...
	public void onDestroy()
	{
		...
		if (activity != null)
		{
			activity.getListenerManagerDispatchTouchEvent().remove(this);
			activity.getListenerManagerDispatchKeyEvent().remove(this);
		}
		super.onDestroy();
	}
	...
	public static class SDSimpleFragmentLifeCircleListener implements SDFragmentLifeCircleListener
	{
