...
public class SDViewPositionHandler
{
	...
	private void process()
	{
		...
		if (newX != oldX)
		{
			...
			if (mListener != null)
			{
				mListener.onXChanged(newX, oldX, newX - oldX);
			}
		}
		...
		if (newY != oldY)
		{
			...
			if (mListener != null)
			{
				mListener.onYChanged(newY, oldY, newY - oldY);
			}
		}
	}
	...
	{
		public void onYChanged(int newY, int oldY, int differ);

		public void onXChanged(int newX, int oldX, int differ);
	}
